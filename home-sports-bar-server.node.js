...
var server = HTTP.createServer(
	function (request, response) {
		...
		if (origin == 'chrome-extension://mccjidcbgbbpbjdoappebgmmddohjofi'
				...
				|| origin == 'chrome-extension://kmkionaahliocgpfglopnnejeacibnfi') {
