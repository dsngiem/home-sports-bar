/*var reloadFlash = function() {
	var videoPlayer = document.getElementById('playerarea')
	var flashObject = document.getElementById('lpPlayer').cloneNode(true)

	videoPlayer.removeChild(document.getElementById('lpPlayer'))
